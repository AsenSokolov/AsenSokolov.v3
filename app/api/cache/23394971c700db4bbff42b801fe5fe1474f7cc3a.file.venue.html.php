<?php /* Smarty version Smarty-3.0.6, created on 2015-07-15 16:06:32
         compiled from "/media/WWW/public/PrimerTalent/modules/admin/venue.html" */ ?>
<?php /*%%SmartyHeaderCode:72069402655a65ad84233e5-60992348%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '23394971c700db4bbff42b801fe5fe1474f7cc3a' => 
    array (
      0 => '/media/WWW/public/PrimerTalent/modules/admin/venue.html',
      1 => 1436429515,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '72069402655a65ad84233e5-60992348',
  'function' => 
  array (
  ),
...
<?php $_template = new Smarty_Internal_Template("modules/admin/header.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
	...
	<!-- Content -->
    <div class="content">
    	<div class="title"><h5>Venue Information</h5></div>
        ...
        <div class="stats">
        	<ul>				
                ...
                <li style="float:right;"><a href="#" class="count green" title=""><?php echo $_smarty_tpl->getVariable('count_venue')->value;?>
...
admin/venue.html" class="basicBtn" id="resetBtn">Reset</a>
			</form>
		</div>
		
        <!-- Static table -->
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">Statistics</h5></div>
...
admin/venue.html?order=approved&order_by=<?php if ($_smarty_tpl->getVariable('order_by')->value=='DESC'){?>ASC<?php }else{ ?>DESC<?php }?><?php if ($_smarty_tpl->getVariable('search')->value){?>&search=<?php echo $_smarty_tpl->getVariable('search')->value;?>
...
<?php }else{ ?>/img/default-company-thumb.png<?php }?>" rel="prettyPhoto">
...
<?php }else{ ?>/img/default-company-thumb.png<?php }?>" />
							</a>
						</td>
...
admin/venue.html?id=<?php echo $_smarty_tpl->tpl_vars['row']->value['id'];?>
...
admin/venue.html?page=<?php echo $_smarty_tpl->getVariable('pager')->value['prev'];?>
...
admin/venue.html?page=<?php echo $_smarty_tpl->tpl_vars['row']->value;?>
<?php if ($_smarty_tpl->getVariable('order')->value){?>&order=<?php echo $_smarty_tpl->getVariable('order')->value;?>
<?php }?><?php if ($_smarty_tpl->getVariable('order_by')->value){?>&order_by=<?php echo $_smarty_tpl->getVariable('order_by')->value;?>
<?php }?><?php if ($_smarty_tpl->getVariable('search')->value){?>&search=<?php echo $_smarty_tpl->getVariable('search')->value;?>
...
admin/venue.html?page=<?php echo $_smarty_tpl->getVariable('pager')->value['next'];?>
<?php if ($_smarty_tpl->getVariable('order')->value){?>&order=<?php echo $_smarty_tpl->getVariable('order')->value;?>
<?php }?><?php if ($_smarty_tpl->getVariable('order_by')->value){?>&order_by=<?php echo $_smarty_tpl->getVariable('order_by')->value;?>
<?php }?><?php if ($_smarty_tpl->getVariable('search')->value){?>&search=<?php echo $_smarty_tpl->getVariable('search')->value;?>
<?php }?>">&gt;</a></li><?php }?>
